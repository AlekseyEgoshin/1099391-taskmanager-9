...
export class TaskEditCard {
  ...
  getTemplate() {
    return `<article class="card card--edit card--${this._color} ${this._repeatingDays[new Date().getDay()] ? `` : ``}">
        <form class="card__form" method="get">
          <div class="card__inner">
            <div class="card__control">
              ...
              <button type="button" class="card__btn card__btn--favorites ${this._favorite ? `` : `card__btn--disabled`}">
                favorites
              </button>
            </div>
              ...
              <div class="card__details">
                ...
                <div class="card__hashtag">
                  <div class="card__hashtag-list">
                    ${!this._tags ? null : Array.from(this._tags).map((tag) => `
