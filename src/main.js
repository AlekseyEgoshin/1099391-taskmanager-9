...
;(function () {
  ...
  const createFilter = () => `<section class="main__filter filter container">
        <input
                type="radio"
                id="filter__all"
                ...
                checked
        />
        <label for="filter__all" class="filter__label">ALL <span class="filter__all-count">15</span></label>
        <input
                type="radio"
                id="filter__overdue"
                class="filter__input visually-hidden"
        ...
        <input
                ...
                name="filter"
        />
        <label for="filter__favorites" class="filter__label">FAVORITES <span class="filter__favorites-count">7</span></label>
        <input
                type="radio"
                ...
                name="filter"
        />
        <label for="filter__repeating" class="filter__label">Repeating <span class="filter__repeating-count">2</span></label>
        <input
                type="radio"
                id="filter__tags"
                class="filter__input visually-hidden"
                name="filter"
        />
        <label for="filter__tags" class="filter__label">Tags <span class="filter__tags-count">6</span></label>
        <input
                type="radio"
                id="filter__archive"
                class="filter__input visually-hidden"
  ...
  const createSearchLine = () => `<section class="main__search search container">
        <input
                type="text"
                id="search__input"
                class="search__input"
  ...
  const createMenu = () => `<section class="control__btn-wrap">
          <input
                  type="radio"
                  name="control"
  ...
  const createButton = () => `<button class="load-more" type="button">
        load more
      </button>`;

  const createTaskEditCard = () => `<article class="card card--edit card--yellow card--repeat">
  ...
  const createBoard = () => `<section class="board container">
  ...
  render(taskListElement, createButton(), `beforeend`);
})();
